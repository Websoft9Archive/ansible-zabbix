...
3. Insert the **HTTPS template** into Zabbix's *server{ }* already existing
   ``` text
   #-----HTTPS template start------------
   listen 443 ssl; 
...
Completed the HTTPS settings on your Server, then you should log in Zabbix, open【Shop Parameters】>【General】, enable HTTPS for all pages
