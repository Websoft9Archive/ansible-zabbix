...
首先,您需要通过创建主机去连接到客户端
![Zabbix 更换语言](https://libs.websoft9.com/Websoft9/DocsPicture/zh/zabbix/zabbix-addhost-websoft9.png)
![Zabbix 更换语言](https://libs.websoft9.com/Websoft9/DocsPicture/zh/zabbix/zabbix-addhost2-websoft9.png)
其次,添加模板配置监控项
![Zabbix 更换语言](https://libs.websoft9.com/Websoft9/DocsPicture/zh/zabbix/zabbix-updatetemplate-websoft9.png)
验证安装,出现如下界面,即为安装成功
![Zabbix 更换语言](https://libs.websoft9.com/Websoft9/DocsPicture/zh/zabbix/zabbix-addok-websoft9.png)
